      ...
      body: SafeArea(
        child: Column(
          children: <Widget>[
            ...
            Text('${playerController1.playerState}'),
            Text('${playerController2.playerState}'),
            Text('${playerController3.playerState}'),
            Text('${playerController4.playerState}'),
            Text('${playerController5.playerState}'),
            Text('${playerController6.playerState}'),
